...
var ngx_masonry_component_1 = require("./ngx-masonry.component");
var NgxMasonryDirective = /** @class */ (function () {
    function NgxMasonryDirective(_element, _parent) {
    ...
    NgxMasonryDirective = __decorate([
        ...
        __param(1, core_1.Inject(core_1.forwardRef(function () { return ngx_masonry_component_1.NgxMasonryComponent; }))),
        __metadata("design:paramtypes", [typeof (_a = typeof core_1.ElementRef !== "undefined" && core_1.ElementRef) === "function" && _a || Object, ngx_masonry_component_1.NgxMasonryComponent])
    ], NgxMasonryDirective);
    return NgxMasonryDirective;
    var _a;
}());
exports.NgxMasonryDirective = NgxMasonryDirective;
//# sourceMappingURL=ngx-masonry.directive.js.map